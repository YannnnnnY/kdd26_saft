...
from saft.src.abs_workflow_nopoison import run_saft_abs
...
def _training_function(
    ...
    run_saft_abs(
        ...
        generating_args,
        callbacks,
        abs_revert=training_args.abs_revert,
        abs_projection=training_args.abs_projection,
        abs_loss_type=training_args.abs_loss_type,
        abs_rescale=training_args.abs_rescale
    )
    print("Revert:", training_args.abs_revert)
    print("Projection:", training_args.abs_projection)
    print("Loss:", training_args.abs_loss_type)
...
def run_exp(
    ...
    if ray_args.use_ray:
        raise RuntimeError("Ray is not supported.")
