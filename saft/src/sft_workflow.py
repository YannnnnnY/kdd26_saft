...
def run_sft(
    ...
    dataset_module = get_saft_dataset(template, template, template, model_args, data_args, training_args, stage="sft", **tokenizer_module)
    ...
    if model_args.use_kt:
        ...
        dataset_module.pop("align_dataset", None)
