...
from saft.src.trainer_fft import SaFTTrainer, OptimizerNames, DistributedType

class FFTABSTrainer(SaFTTrainer):
    """
    ...
    def __init__(
        ...
        super(FFTABSTrainer, self).__init__(*args, **kwargs)
